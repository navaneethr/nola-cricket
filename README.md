...
in all web browsers. Service worker registration [won't be attempted](src/config/registerServiceWorker.js)
...
starting point, you can make use of the logic included in [`src/registerServiceWorker.js`](src/config/registerServiceWorker.js), which
